...
def main():
   ...
   pygame.display.set_caption('Pong Version 2')   
...
class Ball:
   ...
   def move(self):
      ...
      for i in range(0,2):
                     ...
                     if pygame.Rect(350,(self.screen_height/2-35),10,40).collidepoint(self.center[0],self.center[1]):
                        if self.velocity[0]>0:
                           self.velocity[i] = - self.velocity[i]
                     if pygame.Rect(100,(self.screen_height/2-35),10,40).collidepoint(self.center[0],self.center[1]):
                        if self.velocity[0]<0:
                           self.velocity[i] = - self.velocity[i]                        
